          ...
          >
            ...
            <Content>
              <Section style={{padding: "1.5rem 5rem"}}n>
                <SectionTitle style={{marginTop:"1.5rem"}}>저와 함께 인생의 센스를 길러보아요</SectionTitle>
                <SectionContent>
                ...
                <SectionContent>
                  잘 쓴 다이어리 한 권에는 나의 삶이 가득 녹아있어요. 매년 한 권씩
                  다이어리를 완성해 간직해보세요. 시간이 흘러도 언제든 열어볼 수
                  있는 내 삶의 자서전이 될 거예요. 글씨가 예쁘지 않아도 괜찮아요.
                  내 손으로 직접 쓰고, 기록했다는 그 자체만으로 충분히 소중하고
                  가치 있으니까요.
                </SectionContent>
                ...
                <SectionContent>
                  <ul>
                    <li>루틴: 11/4(월) ~ 1/27(월) 매일 bod 다이어리 작성하기</li>
                    <li>
                ...
                <SectionContent>
                  <ul>
                    ...
                    <li>
                      미션 채팅 참여: 채팅방에 참여해서 다른 루틴 참여자와 경험을
                      공유하세요.
                    </li>
                    <li>
                      미션 인증: 온라인 줌 참여 화면 또는 오늘 작성한 bod 다이어리
                      사진과 소감을 남겨주세요.
                    </li>
                    <li>경험치 획득: 각 인증으로 페이지(경험치)를 획득합니다.</li>
